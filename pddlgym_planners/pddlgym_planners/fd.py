...
class FD(PDDLPlanner):
    ...
    def _get_cmd_str(self, dom_file, prob_file, timeout):
        ...
        cmd_str = "{} {} {} {} --sas-file {} {} {} {}".format(
            timeout_cmd, timeout, FD_EXEC, self._alias_flag, sas_file,
    ...
    def _get_cmd_str_searchonly(self, sas_file, timeout):
        ...
        cmd_str = "{} {} {} {} --search {} {}".format(
            timeout_cmd, timeout, FD_EXEC, self._alias_flag,
    ...
    def _cleanup(self):
        """Run FD cleanup
        """
        cmd_str = "{} --cleanup".format(FD_EXEC)
    ...
    def _check_path_fd(self):
        assert shutil.which(FD_EXEC) is not None
        """
